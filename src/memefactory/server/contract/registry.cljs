...
(defn meme-constructed-event [contract-key & args]
  (apply contract-call contract-key :MemeConstructedEvent args))

(defn meme-minted-event [contract-key & args]
  (apply contract-call contract-key :MemeMintedEvent args))
...
(defn vote-amount-claimed-event [contract-key & args]
  (apply contract-call contract-key :VoteAmountClaimedEvent args))

(defn vote-reward-claimed-event [contract-key & args]
  (apply contract-call contract-key :VoteRewardClaimedEvent args))

(defn challenge-reward-claimed-event [contract-key & args]
  (apply contract-call contract-key :ChallengeRewardClaimedEvent args))
