...
(reg-event-fx
 ...
 [interceptors]
 (fn [{:keys [:db]} [{:keys [:meme/title :send-tx/id :meme-auction/token-ids :meme-auction/start-price :meme-auction/end-price :meme-auction/duration :meme-auction/description] :as args}]]
