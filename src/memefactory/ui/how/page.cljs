   ...
   [:div.how-it-works-page
    ...
    [:div.how-it-works.panel
     ...
     [:div.body
      ...
      [:p "Meme Factory is a "
       [:a {:href "https://education.district0x.io/general-topics/understanding-ethereum/understanding-dapps/"} "decentralized application (dApp)"]
       " running on the "
       [:a {:href "https://education.district0x.io/general-topics/understanding-ethereum/what-is-ethereum/"} "Ethereum blockchain"]
       ...
       [:a {:href "https://education.district0x.io/general-topics/understanding-ethereum/erc-721-tokens/"} "unique ERC721"]
       " tokens on the Ethereum blockchain, memes are submitted by individuals, voted into or out of the app by users via a "
       [:a {:href "https://education.district0x.io/general-topics/understanding-ethereum/token-curated-registry/"} "token-curated registry (TCR)"]
       ...
       [:a {:href "https://education.district0x.io/general-topics/understanding-ethereum/what-are-smart-contracts/"} "smart contracts"]
       "."]]]

    [:div.setting-up.panel
     [:div.icon]
     [:h2.title "Setting up"]
     ...
     [:div.body
      [:p "The first thing you will need is an Ethereum wallet. On a mobile device, you can download any mobile Ethereum browser from the playstore. We’d recommend "
       [:a {:href "https://wallet.coinbase.com/"} "Coinbase Wallet"]
    ...
    [:div.buying-memes.panel
     [:div.icon]
     [:h2.title "Buying memes"]
    ...
    [:div.getting-dank.panel
     [:div.icon]
     [:h2.title "Getting DANK"]
     ...
     [:div.body
      ...
      [:p "DANK is a brand new "
       ...
       [:a {:href "https://education.district0x.io/general-topics/what-is-governance/"} "governance"]
    ...
    [:div.challenging.panel
     [:div.icon]
     [:h2.title "Challenging"]
    ...
    [:div.submitting-memes.panel
     [:div.icon]
     [:h2.title "Submitting Memes"]
