...
(def steps
  [
   ...
   #_10 {"custom a.dank-registry-vote" "Once you've acquired some DANK, we can get started voting." :showSkip false}
   #_11 {"next .tabbed-panel" "This page shows all open challenges against new meme submissions. When a challenge is initiated, a period of voting begins. Any DANK you own can be used as voting power to decide whether a new meme goes to auction or gets rejected." :showSkip false}
   ...
   #_16 {"custom a.dank-registry-challenge" "Starting a challenge is also easy. Keep in mind however, unlike voting, you can actually lose DANK while challenging. To get started, press the \"Challenge\" button." :showSkip false}
