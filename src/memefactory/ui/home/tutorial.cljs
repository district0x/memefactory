...
(def steps
  [
   #_1  {"custom a.marketplace" "At it's core, Meme Factory is a decentralized marketplace for collectible memes." :showSkip false}
   ...
   #_5  {"click a.memefolio" "At it's core, Meme Factory is a decentralized marketplace for collectible memes." :showSkip false}
   #_6  {"next .memefolio-page" "<font color=\"#FF0090\">Your Memefolio contains your current collection of memes as well as a complete history of memes you've bought and sold.</font>" :showSkip false}
   ...
   #_8  {"click a.faucet" "In order to start curating, you need a special token for the job, called DANK." :showSkip false}
   ...
   #_10 {"click a.dank-registry-vote" "Once you've acquired some DANK, we can get started voting." :showSkip false}
        ;; TODO number 11 is skipping
   #_11 {"custom .tabbed-panel" "This page shows all open challenges against new meme submissions. When a challenge is initiated, a period of voting begins. Any DANK you own can be used as voting power to decide whether a new meme goes to auction or gets rejected." :showSkip false}
   ...
   ;; TODO last child doesn't work
   #_15 {"next .tabs-tiles>.tab:last-child" " After the reveal period ends, the challenge moves to the resolved tab. Any rewards from winning votes or challenges can be claimed here." :showSkip false}
   #_16 {"click a.dank-registry-challenge" "Starting a challenge is also easy. Keep in mind however, unlike voting, you can actually lose DANK while challenging. To get started, press the \"Challenge\" button." :showSkip false}
   #_17 {"next .challenge:first" "This page displays every new meme submitted for entry into the registry. All memes must survive a challenge period to make it into the registry uncontested. If challenged, memes will go to the voting phase." :showSkip false}
   ...
   #_19 {"next a.dank-registry-vote" "New challenges move to the vote page. When voting concludes, rewards from complete challenges can be claimed from the \"Resolved Challenges\" tab on the vote page, or in your Memefolio." :showSkip false}
   #_20 {"click a.dank-registry-submit" "The final major feature of Meme Factory is, of course, creating memes. This is done with DANK on the \"Submit\" page." :showSkip false}
   ...
   #_22 {"next .form-panel" "Submissions require names, and tags to index them for searching. Be creative, but also descriptive here. You must also choose a number of individual cards to mint and issue for sale. You can leave a comment to provide any other information you think challengers or voters might need." :showSkip false}
   #_23 {"next a.dank-registry-challenge" "Memes that are submitted move to the Challenge phase. Any creations of yours can always be found in the \"Created\" tab of the \"My Memefolio\" page, where you can issue accepted memes for sale." :showSkip false}
   #_24 {"next a.my-settings" "The settings page allows you to link your email address in order to sign up for notifications. This will provide updates on any memes you've created, challenged, or voted for." :showSkip false}
   #_25 {"next a.how-it-works" "Any additional questions are likely answered in our \"How it works\" walkthrough. Welcome to Meme Factory!" :showSkip false}
   ])
