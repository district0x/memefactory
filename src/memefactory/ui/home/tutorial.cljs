...
(def steps
  [
   ...
   #_11 {"next .challenge:first" (with-background "This page shows all open challenges against new meme submissions. When a challenge is initiated, a period of voting begins. Any DANK you own can be used as voting power to decide whether a new meme goes to auction or gets rejected.") :showSkip false}
