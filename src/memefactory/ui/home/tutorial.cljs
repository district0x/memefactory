...
(def steps
  [
   ...
   #_6  {"next .memefolio-page" (with-color "#FF0090" "Your Memefolio contains your current collection of memes as well as a complete history of memes you've bought and sold.") :showSkip false}
   ...
   #_11 {"next .tabbed-panel" (with-color "#FF0090" "This page shows all open challenges against new meme submissions. When a challenge is initiated, a period of voting begins. Any DANK you own can be used as voting power to decide whether a new meme goes to auction or gets rejected.") :showSkip false}
   ...
   #_17 {"next .challenge:first" (with-color "#FF0090" "This page displays every new meme submitted for entry into the registry. All memes must survive a challenge period to make it into the registry uncontested. If challenged, memes will go to the voting phase.") :showSkip false}
