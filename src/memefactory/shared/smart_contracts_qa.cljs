...
(def smart-contracts
  {:district-config {:name "DistrictConfig",
   ...
   :param-change {:name "ParamChange",
                  :address "0x2f67fa725ff37f84d1a157ccbcbd9662c8dcfbe8"},
   ...
   :param-change-factory {:name "ParamChangeFactory",
                          :address "0xc60cd84b16a5c00e7335b62b3ca238ecef2ca880"},
   ...
   :meme-factory {:name "MemeFactory",
                  :address "0x64063c81b09bedf0d15428ebf7a27ed462c82dab"},
   ...
   :meme {:name "Meme",
          :address "0xa536c514fe7b4e8037ae30921992065e88290c78"},
