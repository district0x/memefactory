...
(def smart-contracts
  {:district-config {:name "DistrictConfig",
   ...
   :param-change {:name "ParamChange",
                  :address "0xbaf96cc50ce1a0240fc6fd52ae6f0d8fadc2bded"},
   ...
   :param-change-factory {:name "ParamChangeFactory",
                          :address "0x3f5799b98e4982e2c38c2d8da69909e9c0b5c2f1"},
   ...
   :meme-factory {:name "MemeFactory",
                  :address "0x8c0ef9b92dab8497b5d80d9fe7b6e3259475769e"},
   ...
   :meme {:name "Meme",
          :address "0x8f389f672ef0586628689f9227e1d0e09f9a3245"},
