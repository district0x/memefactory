...
- [ ] Submit screen, max total supply hint and error messages are wrong                                       (Juan)
- [ ] DANK balance in below challege button needs to be divided by 1e18                                       (Juan)
- [ ] DANK Balance didn't went down when voting, maybe voting in wei?
- [ ] DANK Balance didn't went down when voting, maybe voting in wei?
- [ ] Collected rank and largest buy spinning forever in memefolio
- [ ] Created best single card sale spinnig forever in memefolio
- [ ] When opening page at memefolio/index doesn show Collected until you switch to other tab and back
- [ ] Sell functionality, duration should be less than is not showing
