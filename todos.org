...
- [ ] Memefolio colector rank not displaying                                                                  (Juan)    <- Waiting for rank definition
...
- [ ] dankregistry/vote max tokens number is not right                                                        ()
- [ ] leaderboards/dankest doesn't show any memes                                                             ()
- [ ]  leaderboards/creators selector doesn;t display the total number (is nil)                               ()
