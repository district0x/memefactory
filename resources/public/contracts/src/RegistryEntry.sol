...
contract RegistryEntry is ApproveAndCallFallBack {
  ...
  MiniMeToken public constant registryToken = MiniMeToken(0xBEeFbeefbEefbeEFbeEfbEEfBEeFbeEfBeEfBeef);
  uint public version;
  ...
  public
  {
    ...
    RegistryEntryToken(meta.token).construct(_name);
    RegistryEntryToken(meta.token).mint(this, _totalSupply);
