...
contract Parameterizer {
  ...
  @param _deposit       minimum deposit for listing to be whitelisted
  @param _pDeposit      minimum deposit to propose a reparameterization
  ...
  */
  function Parameterizer( 
    ...
    uint _maxStartPrice
      ...
      set("maxTotalSupply", _maxTotalSupply);
      set("maxStartPrice", _maxStartPrice);
  }
