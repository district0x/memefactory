...
solc-err-only --overwrite --optimize --bin --abi MemeAuctionFactory.sol -o ../build/
...
wc -c MemeAuctionFactory.bin | awk '{print "MemeAuctionFactory: " $1}'
wc -c MemeAuction.bin | awk '{print "MemeAuction: " $1}'
...
wc -c DistrictConfig.bin | awk '{print "DistrictConfig: " $1}'
